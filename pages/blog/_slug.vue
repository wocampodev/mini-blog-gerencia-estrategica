<template>
  <div>
    <div
      class="min-h-50 max-w-7xl lg:pt-20 mx-auto grid sm:grid-cols-1 lg:grid-cols-4"
    >
      <div class="sm:pt-10 lg:col-span-1 lg:relative">
      ...
      <div class="lg:container pt-10 lg:col-span-3">
        <div class="lg:px-6 text-xl text-gray-800 leading-normal">
          <div>
